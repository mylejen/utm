...
if (myipaddress == "183.171.27.151" || myipaddress == "183.171.16.18" || myipaddress == "183.171.29.155" || myipaddress == "183.171.29.217" || myipaddress == "115.164.204.49" || myipaddress == "14.192.213.30" || myipaddress == "180.75.241.55") {
...
if (typeof PageData !== 'undefined' && PageData.uuid !== null) {
    ...
    if (campaignParam) {
        ...
        for (let i = 0; i < allCampaignDivs.length; i++) {
            ...
            if (campaignText.includes(divId)) {
                ...
                allCampaignDivs.forEach(d => {
                    if (d.id !== defaultId) d.style.display = 'none';
                });
