...
console.log("2: " + salesStats.total_amount_all);
console.log("3: " + PageData.salesStats.total_amount_all);
console.log("4: " + PageData);
console.log("5: " + customDonationCurrentValue);

let total_amount_all = null;
let salesStats.total_amount_all = null;
let PageData.salesStats.total_amount_all = null;
let PageData = null;
