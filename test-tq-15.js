...
script.onload = () => {
	...
	const hasRunAxios = sessionStorage.getItem("hasRunAxios");
	const hasRunUrl = sessionStorage.getItem("hasRunUrl");
		  if (hasRunAxios !== "1" && hasRunUrl !== currenturl) {
	    ...
	    useragent: myuseragent,
		  ...
		  sessionStorage.setItem("hasRunUrl", currenturl);
		  }
